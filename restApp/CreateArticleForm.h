...
namespace restApp {
	...
	public ref class CreateArticleForm : public System::Windows::Forms::Form
	{
	public:
		Form^ previousForm;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(CreateArticleForm::typeid));
			...
			this->label2->Size = System::Drawing::Size(510, 61);
			this->label2->TabIndex = 1;
			this->label2->Text = L"KREIRAJ ARTIKLE";
			// 
			// backBtn
			// 
			...
			this->backBtn->Click += gcnew System::EventHandler(this, &CreateArticleForm::backBtn_Click);
			// 
			// confirmRegBtn
			// 
			...
			this->confirmRegBtn->Text = L"KREIRAJ";
			this->confirmRegBtn->UseVisualStyleBackColor = false;
			this->confirmRegBtn->Click += gcnew System::EventHandler(this, &CreateArticleForm::confirmRegBtn_Click);
			// 
			// articleNameTextBox
			// 
			...
			this->pfpButton->Click += gcnew System::EventHandler(this, &CreateArticleForm::pfpButton_Click);
			// 
			// label1
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &CreateArticleForm::button2_Click);
			// 
			// tagCheckListBox
			// 
			...
			this->priceTextBox->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &CreateArticleForm::priceTextBox_KeyPress);
			// 
			// pictureBox1
			// 
			...
			this->Name = L"CreateArticleForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"FFDM Restoranska Aplikacija";
			this->VisibleChanged += gcnew System::EventHandler(this, &CreateArticleForm::CreateArticleForm_VisibleChanged);
...
#pragma endregion
	...
	private: System::Void confirmRegBtn_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		switch (articleCreate(getActiveUser(), newArt)) {
		case 0:
			...
			MessageBox::Show("Uspesno ste kreirali artikal.\n Vratite se na prethodni prozor da ga vidite.", "Uspeh Kreiranja", MessageBoxButtons::OK,
		...
		case 1:
			...
			MessageBox::Show("Ovaj Artikal Vec postoji u Vasem meniju.", "Greska u kreiranju", MessageBoxButtons::OK,
			MessageBoxIcon::Information);
			break;
		case 3:
			label5->ForeColor = System::Drawing::Color::FromArgb(231, 224, 139);
			label7->ForeColor = System::Drawing::Color::Brown;
			label8->ForeColor = System::Drawing::Color::FromArgb(231, 224, 139);
			MessageBox::Show("Niste dali ime artiklu.", "Greska u kreiranju", MessageBoxButtons::OK,
			MessageBoxIcon::Information);
			break;
		case 4:
			...
			label7->ForeColor = System::Drawing::Color::FromArgb(231, 224, 139);
			label8->ForeColor = System::Drawing::Color::FromArgb(231, 224, 139);
			MessageBox::Show("Niste podesili sastojke Vaseg artikla.", "Greska u kreiranju", MessageBoxButtons::OK,
			MessageBoxIcon::Information);
			break;
		case 5:
			label5->ForeColor = System::Drawing::Color::FromArgb(231, 224, 139);
			...
			label7->ForeColor = System::Drawing::Color::FromArgb(231, 224, 139);
			MessageBox::Show("Niste podesili tagove Vaseg artikla.", "Greska u kreiranju", MessageBoxButtons::OK,
			MessageBoxIcon::Information);
			break;
		}
	...
	private: System::Void CreateArticleForm_VisibleChanged(System::Object^ sender, System::EventArgs^ e) {
		bool exists = false;
		rest thisRest = restGet(getActiveUser());
		for each (ingr ing in thisRest.inventory) {
			String^ existingResName = marshal_as<String^>(ing.name);

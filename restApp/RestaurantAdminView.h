...
namespace restApp {
	...
	/// </summary>
	public ref class RestaurantAdminView : public System::Windows::Forms::Form
	{
	public:
		Form^ previousForm;
		RestaurantAdminView(void)
		{
			InitializeComponent();
		}
		RestaurantAdminView(rest restt)
		{
		...
		RestaurantAdminView(rest restt, Form^ form)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(RestaurantAdminView::typeid));
			...
			this->restNameLabel->Location = System::Drawing::Point(122, 7);
			...
			this->backBtn->Click += gcnew System::EventHandler(this, &RestaurantAdminView::backBtn_Click);
			// 
			// menuFlowLayoutPanel
			// 
			...
			this->restDescriptionLabel->MaximumSize = System::Drawing::Size(468, 50);
			...
			this->searchTextBox->TextChanged += gcnew System::EventHandler(this, &RestaurantAdminView::searchTextBox_TextChanged);
			// 
			// label2
			// 
			...
			this->button1->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(55)),
				static_cast<System::Int32>(static_cast<System::Byte>(122)));
			this->button1->Location = System::Drawing::Point(276, 728);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(186, 77);
			this->button1->TabIndex = 35;
			this->button1->Text = L"Korisnicka Statistika";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &RestaurantAdminView::button1_Click);
			// 
			// RestaurantAdminView
			// 
			...
			this->Name = L"RestaurantAdminView";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"FFDM Restoranska Aplikacija";
			this->VisibleChanged += gcnew System::EventHandler(this, &RestaurantAdminView::MyMenuForm_VisibleChanged);
...
#pragma endregion
	...
	private: System::Void MyMenuForm_VisibleChanged(System::Object^ sender, System::EventArgs^ e) {
		...
		for each (article art in articles) {
			...
			MakeOrderArticleItem^ item = gcnew MakeOrderArticleItem(art.name, art.desc, art.imagePath, art.tags, art.price, false);
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		StatisticsForm^ statForm = gcnew StatisticsForm(this);
		this->Hide();
		statForm->Show();
	}
};

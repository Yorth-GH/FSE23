...
namespace userApp {
	...
	public:
		...
		MakeOrderArticleItem(string name, string description, string imagePatharg, vector<string> tags, double pricearg)
		{
			InitializeComponent();
			...
			if (imagePatharg.empty()) {
				...
				imgPathLabel->Text = marshal_as<System::String^>("restUser.png");
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(231)), static_cast<System::Int32>(static_cast<System::Byte>(224)),
				static_cast<System::Int32>(static_cast<System::Byte>(139)));
			this->label1->Location = System::Drawing::Point(494, 95);
